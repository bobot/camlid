...
## Files
    ...
    - [`generated/mylib_stub.h`](mylib_stub.h) generated by camlid from `generator/generator.ml`, contains the definition of the generated type. Includes `lib.h`.
    - [`generated/mylib_stub.c`](mylib_stub.c) generated by camlid from `generator/generator.ml`, contains the definition of the generated function stub. Includes `mylib_stub.h` and `defs.h`.
    - [`generated/mylib.ml`](mylib.ml) generated by camlid from `generator/generator.ml`, contains the definition of the external for the generated function stub.
