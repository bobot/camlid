...
static void camlid_ml2c1(value * v, intptr_t * c){ *c = Long_val(*v); }
...
static void camlid_c2ml1(value * v, intptr_t * c){ *v = Val_long(*c); }
...
static void camlid_c2ml4(size_t array_len, value * v, intptr_t* * c){
  CAMLparam0 ();
  CAMLlocal1(cid_temp);
...
static void camlid_free4(intptr_t* * c){ free(*c); }
